...
<div ng-controller="Pruebas" ng-init="load('data-camisas-dia',{semana:semanaActual})"></div>
<b style="font-size: 14pt;"></b><input type="week" ng-model="semanaActual" /><button class="btn" ng-click="load('data-camisas-dia',{semana:semanaActual})">Ver</button>
