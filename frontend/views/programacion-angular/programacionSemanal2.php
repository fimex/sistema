...
<div class="panel panel-default">
    ...
    <table ng-table fixed-table-headers="semanal" class="table table-striped table-bordered table-hover">
        ...
        <tbody style="font-size: 10pt">
            ...
            <?php if($area == 3){ ?>
                <th ng-show="mostrar" > <input type="checkbox" ng-disabled="programacion.Estatus == 'Cerrado'" class="form-control" name="Cerrado[]" value="{{programacion.IdProgramacion}}"  /></th>
            <?php } ?>
                ...
                <th ng-show="mostrar" style="min-width: 150px">{{programacion.FechaEnvio | date:'dd-MMM-yyyy'}}</th>
            ...
            <?php }else{ ?>
                <th style="max-width: 50px">{{programacion.Ensamble == 2 ? programacion.Cantidad : programacion.SaldoCantidad}}</th>
