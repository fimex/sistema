...
<div class="panel panel-default">
    ...
    <table fixed-table-headers="semanal" cell-fixed="semanal" class="table table-striped table-bordered table-hover">
        <?php if($IdArea == 3): ?>
            <thead>
                <tr>
                    <th ng-show="mostrar" style="min-width: 30px; max-width: 30px;" rowspan="2"></th>
                    <th ng-show="mostrar" style="min-width: 100px; max-width: 100px;" style="font-size: 10pt" rowspan="2">
            ...
            <tbody style="font-size: 10pt">
                <tr style="{{programacion.class}}" 
                    ...
                    <th class="fixed" style="max-width: 100px; background:{{programacion.ColorProducto}}">{{programacion.ProductoCasting}}</th>
        ...
        <tbody style="font-size: 10pt">
            <tr style="{{programacion.class}}"
                ...
                <th ng-show="mostrar"> 
                    <input type="checkbox" class="form-control" name="Cerrado[]" value="{{programacion.IdProgramacion}}"  />
                </th>
                <th ng-show="mostrar" style="max-width: 100px;">{{programacion.Marca}}</th>
                <th title="{{programacion.Descripcion}}" ng-show="mostrar">{{programacion.Descripcion | uppercase | limitTo : 15}}</th>
