    ...
    <div id="detalle">
        <table ng-table class="table table-condensed table-striped table-bordered">
            ...
            <tr ng-class="{'info': indexDetalle == $index}" ng-repeat="detalle in programacionAceros">
                ...
                <?php if($IdSubProceso != 17): ?>
                <th><button type="button" ng-show="(IdSubProceso == 9)" ng-click="ModelMoldeo($index,1);" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button></th>
                <th>{{detalle.Cerradas | currency:"":1}}</th>
                <th>
                    <button type="button" ng-show="IdSubProceso == 9" ng-click="ModelMoldeo($index,3);" class="btn btn-danger btn-sm">
                        <span class="glyphicon glyphicon-minus" aria-hidden="true"></span>
                    </button>
                </th>
