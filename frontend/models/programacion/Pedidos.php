 ...
 * @property integer SaldoExistenciaPT
...
class Pedidos extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['IdAlmacen', 'IdProducto', 'Codigo', 'Numero', 'Estatus', 'NivelRiesgo', 'SaldoExistenciaPT'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'SaldoExistenciaPT'=> 'SaldoExistenciaPT',
        ];
    }
    ...
    public function getMarcas($area = '')
    {
        ...
        $result =$command->createCommand("SELECT Distinct 
            ...
            FROM v_PedidosPorProgramar Where IdPresentacion = $area
        ")->queryAll();
