 ...
 */
class ProgramacionAlmas extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function getProgramacionSemanal($data)
    {
        ...
        $command = \Yii::$app->db;
        $result =$command->createCommand("SELECT * FROM f_GetProgramacionesAlmas($area,$params)")->queryAll();
    ...
    public function getProgramacionDiaria($data,$proceso,$turno)
    {
        ...
        $command = \Yii::$app->db;
        $result =$command->createCommand("SELECT * FROM f_GetProgramacionesAlmasDiaria($area,$params)")->queryAll();
    ...
    {
        $command = \Yii::$app->db;
        $result =$command->createCommand("EXECUTE p_SetProgramacionAlmaDia $data,NULL")->execute();
    }
    public function setProgramacionSemanal($data)
    {
        $command = \Yii::$app->db;
        $result =$command->createCommand("EXECUTE p_SetProgramacionAlmasSemana $data,NULL")->execute();
    }
