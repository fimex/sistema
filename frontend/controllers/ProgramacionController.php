...
class ProgramacionController extends Controller
{
    ...
    public function SetPedProgramacion($pedidoDat,$producto, $Area){
       ...
       //echo "string".$Acumulado[0]['IdProgramacion']; exit();
        if($area['AgruparPedidos'] == 1){
            //var_dump($Acumulado);       
            if(isset($Acumulado[0]['IdProgramacion'])){
            echo "Actualizar".$Acumulado[0]['IdProgramacion'];
                ...
                $model = PedProg::find()->where("IdPedido = $pedidoDat->IdPedido")->asArray()->all();
               //print_r($model); 
               //exit();
                if($model == null){  
